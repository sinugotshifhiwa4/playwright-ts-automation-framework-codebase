...
**New here? Start with [ARCHITECTURE.md](ARCHITECTURE.md).** It is the only page that shows the
whole framework at once — what happens end to end when a test runs, and which page documents
which folder. Everything else is deliberately narrow.

| Section                                                        | What it covers                                                              | Applies                                              |
| -------------------------------------------------------------- | --------------------------------------------------------------------------- | ---------------------------------------------------- |
| [ARCHITECTURE.md](ARCHITECTURE.md)                             | The whole framework: the runtime flow, and where each folder is documented. | On demand — read first, then follow the links.       |
...
| **[05 — Commands](05-commands/README.md)**                     | What to type: the test and quality commands, and every runtime flag.        | On demand — read before running the suite.           |
